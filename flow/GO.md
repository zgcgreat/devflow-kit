...
3. 根据用户选择：
   - 选 1 → 用户回答问题 → 生成 00-需求确认.md + 01-需求分析.md
   - 选 2 → 等待新文档 → 重新解析
...
├─────────────────────────────────────────────────────────────┤
│  建议路径：                                                   │
│  [1] 回答问题后进入 2a-ui-design                             │
│  [2] 已有需求文档，直接进入 2a-ui-design                      │
│  [3] 先走 0-confirm 确认需求范围                              │
└─────────────────────────────────────────────────────────────┘
```
...
| 等级 | 标准 | 处理方式 |
|------|------|----------|
| **高** | 有明确 AC、范围清晰、无歧义、非功能性需求完整 | 直接生成 01-需求分析.md，进入下一阶段 |
| **中** | 有功能描述但 AC 不完整、有少量歧义 | 针对性反问 1-2 轮，补全后生成产物 |
| **低** | 只有笼统描述、多处歧义、范围不明 | 建议补充文档，或走 0-confirm 反问模式 |

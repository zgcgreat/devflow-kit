...
- `@.specs/上下文.md`（必读 · 技术栈 + 既有抽象 + 禁动清单）
- `@.specs/系统架构.md`（如有，则是重构跑；如无，则是首跑）
- `@.specs/需求LOG.md`（看历史 req 演进轨迹）
- `@.specs/archive/*/02-方案设计.md`（按需 · 重构跑时抽样几份）
...
- 先备份：`cp .specs/系统架构.md .specs/系统架构.md.bak-<YYYY-MM-DD>`

...
> ⚠️ **进入本阶段前，必须先加载**：`devflow-kit/agent-skills/skills/api-and-interface-design/_SKILL.md`、`devflow-kit/agent-skills/skills/source-driven-development/_SKILL.md`、`devflow-kit/agent-skills/skills/documentation-and-adrs/_SKILL.md`
...
使用 `@devflow-kit/flow/templates/02-方案设计.md` 模板产出，**保存到 `.specs/<req-id>/02-方案设计.md`**。必须覆盖：

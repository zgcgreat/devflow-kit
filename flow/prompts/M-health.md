...
使用 `@devflow-kit/flow/templates/健康巡检.md` 模板，写入 `.specs/health/<YYYY-MM-DD>-HEALTH.md`。
...
- `.specs/health/<YYYY-MM-DD>-HEALTH.md`（必产，使用 `@devflow-kit/flow/templates/健康巡检.md` 模板）

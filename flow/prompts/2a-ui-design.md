...
- `@.specs/<id>/00-需求确认.md`（**必读**，含 0-confirm 阶段已选的「视觉调性」）
- `@.specs/<id>/01-需求分析.md`
- `@.specs/<id>/02-方案设计.md`（**必读 `## 0. 技术栈选定` 段**——字体 / UI 库 / 组件库 / 图标库的选择必须基于这个栈）
- `@.specs/上下文.md`
...
- **说"可以 go"** → 进步骤 4，写完整 02a-UI设计.md（保存到 `.specs/<id>/02a-UI设计.md`）

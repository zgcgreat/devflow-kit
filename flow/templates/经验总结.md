...
> 项目级常驻文件，位置：`.devflow-kit/经验总结.md`
...
AI 扫本次需求 的所有 `*-开发记录.md` 与遗留 `*-开发中断快照.md`，按下面「提名条件」筛选并追加新条目。
...
- 详见 `.devflow-kit/archive/2026-04-30-add-dark-mode/开发记录.md` 的"决策与偏离"段

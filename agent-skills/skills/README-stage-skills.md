...
├── stage-1-analysis/         # 需求分析（TODO）
├── stage-2-design/           # 方案设计
├── stage-2a-ui-design/       # UI设计（TODO）
├── stage-3-task/             # 任务拆分
├── stage-3a-plan/            # 实施计划（TODO）
├── stage-4-dev/              # 开发执行
├── stage-5-test/             # 测试验证（TODO）
├── stage-6-review/           # 代码审查（TODO）
├── stage-7-integration/      # 集成发布（TODO）
├── stage-a-architect/        # 架构梳理（TODO）
├── stage-a-evolve/           # 架构演进（TODO）
├── stage-m-health/           # 健康检查（TODO）
├── stage-i-intel-scan/       # 入场扫描（TODO）
...
6. 编写自检清单
7. 编写约束和错误处理
8. 更新 `stage-orchestrator/_SKILL.md` 的映射表
9. 提交PR

## 相关链接

- [GO.md](../../flow/GO.md) - 工作流总控
- [Prompts](../../flow/prompts/) - 阶段prompt文件
- [Templates](../../flow/templates/) - 产物模板
- [Reference](../../flow/reference/) - 参考文档

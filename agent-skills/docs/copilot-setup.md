...
cat /path/to/agent-skills/skills/test-driven-development/_SKILL.md > .github/skills/test-driven-development/_SKILL.md
cat /path/to/agent-skills/skills/code-review-and-quality/_SKILL.md > .github/skills/code-review-and-quality/_SKILL.md
```

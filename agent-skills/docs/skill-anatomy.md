...
skills/
  skill-name/
    _SKILL.md           # Required: The skill definition
...
- Reference material exceeds 100 lines (keep the main _SKILL.md focused)
...
5. **Progressive disclosure.** Main _SKILL.md is the entry point. Supporting files are loaded only when needed.
...
- Skill files: `_SKILL.md` (always uppercase)

...
> 项目级常驻文件，位置：`.devflow-kit/lessons-learned.md`
...
AI 扫本次需求 的所有 `*-dev-log.md` 与遗留 `*-dev-snapshot.md`，按下面「提名条件」筛选并追加新条目。
...
- **季度剪枝**：deprecated > 6 个月的条目移到 `.devflow-kit/archive/LESSONS-archive.md`
...
- 详见 `.devflow-kit/archive/2026-04-30-add-dark-mode/dev-log.md` 的"决策与偏离"段
